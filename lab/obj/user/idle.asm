...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002d2:	68 af 0f 80 00       	push   $0x800faf
  8002d7:	6a 23                	push   $0x23
  8002d9:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_ipc_recv(void *dstva)
{
  ...
  800336:	68 af 0f 80 00       	push   $0x800faf
  80033b:	6a 23                	push   $0x23
  80033d:	68 cc 0f 80 00       	push   $0x800fcc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036b:	56                   	push   %esi
  80036c:	50                   	push   %eax
  80036d:	68 dc 0f 80 00       	push   $0x800fdc
  ...
  80037e:	e8 54 00 00 00       	call   8003d7 <vcprintf>
	cprintf("\n");
  800383:	c7 04 24 ff 0f 80 00 	movl   $0x800fff,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004d6:	0f be 80 01 10 80 00 	movsbl 0x801001(%eax),%eax
  8004dd:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006a1:	50                   	push   %eax
  8006a2:	68 19 10 80 00       	push   $0x801019
  8006a7:	53                   	push   %ebx
  8006a8:	56                   	push   %esi
  ...
  8006b9:	52                   	push   %edx
  8006ba:	68 22 10 80 00       	push   $0x801022
  8006bf:	53                   	push   %ebx
  8006c0:	56                   	push   %esi
  ...
  8006de:	b8 12 10 80 00       	mov    $0x801012,%eax
